...
<body>
	...
	<!--  End Header Section  -->
	<br><p class="container b"><a href="homepage.php">Home</a>><a href="aircraft.php">Aircrafts</a>><a href="#">Airbus Aircrafts</a></p>
	<br>
	<div class="columns ">
	  <div class="column main-column ">
		<article class="article ">
		  <figure class="article-image is-4by3">
        <img src="img/Airbus A350.jpg" alt="A350">
      </figure>
		  <h2 class="article-title"><a href="airbus350.php">Airbus A350 XWB</a></h2>
